...
class Login_Page extends StatelessWidget {
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(primaryColor: Color(0xffffffff)), // Colors.grey[700]),

      home: Scaffold(
        //기본적인 틀을 위한 컨테이너 생성
        body: Container(
          color: const Color(0xffffffff), // 흰색 white
          ...
          child: Column(
            children: <Widget>[
              Container(
                width: MediaQuery.of(context).devicePixelRatio * (235),
                height: MediaQuery.of(context).devicePixelRatio * (187),
